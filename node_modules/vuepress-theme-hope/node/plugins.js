...
const resolveComponentsOptions = (themeConfig) => ({
    ...(themeConfig.components || null),
    backToTop: themeConfig.backToTop !== false,
    backToTopThreshold: typeof themeConfig.backToTop === "number" ? themeConfig.backToTop : 300,
    breadcrumb: true,
    badge: true,
    pageinfo: true,
    pagination: true,
    ...
    return themeConfig.feed === false
        ...
        : {
            ...
            channel: {
                ...
                ...(((_a = themeConfig.feed) === null || _a === void 0 ? void 0 : _a.channel) || null),
            },
        };
};
const resolveMarkdownEnhanceOptions = (themeConfig) => ({
    container: true,
